    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="">KWHITE CATERING</a>
                <a class="navbar-brand hidden" href="">KC</a>
            </div>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="index.html"> <i class="menu-icon fa fa-puzzle-piece"></i>Food </a>
                    </li>
                    <li>
                        <a href="index.html"> <i class="menu-icon fa fa-puzzle-piece"></i>Review </a>
                    </li>
                    <li>
                        <a href="index.html"> <i class="menu-icon fa fa-puzzle-piece"></i>Information </a>
                    </li>
                </ul>
            </div>
        </nav>
